  ...
  if (!test && !submitted) {
    return (
      <div className="mock-test-container">
        ...
        <p>Simulate the actual interview-level test for {user?.targetCompany}</p>
    ...
    return (
      <div className="mock-test-result">
        ...
        <div className="result-score">
          ...
          <p>{result.overallScore} / {result.totalQuestions} Correct</p>
        </div>

        <div className="performance-analysis">
          <h4>Performance Analysis</h4>
          <p><strong>Strength:</strong> {result.performanceAnalysis?.strength}</p>
        ...
        <div className="feedback-card">
          ...
          <p className="note">Note: This feedback is based on your current performance and helps you prepare effectively for {user?.targetCompany}.</p>
        </div>
