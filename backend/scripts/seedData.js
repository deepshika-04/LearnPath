...
const companies = [
  {
    ...
    frequentlyAskedTopics: ['Arrays', 'Trees', 'Graphs', 'Dynamic Programming', 'Linked Lists'],
...
const sampleQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'DFS (Depth-First Search) uses a stack, while BFS (Breadth-First Search) uses a queue.'
  },
  {
    topic: 'DBMS',
    difficulty: 'Easy',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'The OSI model has 7 layers defining how network communication occurs.'
  },
  {
    topic: 'Aptitude',
    difficulty: 'Easy',
    question: 'If A can do a work in 10 days and B can do the same work in 15 days, in how many days can they do it together?',
    options: ['6 days', '25 days', '30 days', '12.5 days'],
    correctAnswer: 0,
    explanation: 'Combined work rate = 1/10 + 1/15 = 5/30 = 1/6, so they need 6 days.'
  }
];
...
const sampleResources = [
  {
    ...
    description: 'Practice array and string problems commonly asked in interviews.',
